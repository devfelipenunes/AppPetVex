...
import { Header, Screen, TopScreen } from "../components";
  ...
  return (
    <Screen>
      ...
      <Header
        ...
        description="Antes de prosseguir com a criação do Certificado Veterinário Internacional, é importante garantir que todos os requisitos sejam atendidos. Preencha as informações necessárias abaixo e verifique a validade de cada requisito:"
      />
      <VStack space={5}>
        {data.map((item, index) => (
